...
public class WheelView extends View {
    ...
    public void setAdapter(WheelAdapter adapter) {
        ...
        if (adapter.getItemsCount() < currentItem + 1) {
            setCurrentItem(0);
        }
        invalidateLayouts();
        invalidate();
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            int[] colors = {Color.parseColor("#70222222"), Color.parseColor("#70222222"), Color.parseColor("#70EEEEEE")};
            centerDrawable = new GradientDrawable(Orientation.TOP_BOTTOM, colors);
            centerDrawable.setStroke(1, Color.parseColor("#70333333"));
            centerDrawable.setAlpha(100);
        }
...
//		setBackgroundResource(RUtil.getInstance().getDrawableId(context, "wheel_bg"));
    }
