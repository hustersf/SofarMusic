...
public class ManagerFragment extends LazyLoadBaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    private void LoadMusic() {
        ...
        activity.requestPermissions(des, permissions, READ_EXTERNAL_CODE, new PermissionsResultListener() {
            @Override
