...
/**
 * BottomSheetDialog默认行为 弹出高度是最大高度的一半
 *
 * 修改BottomSheetDialog弹出高度和最大高度一样
 */
public class SofarBottomSheetDialog extends BottomSheetDialog {

  private Context mContext;
  private BottomSheetBehavior mBottomSheetBehavior;
  private Window mWindow;

  public SofarBottomSheetDialog(@NonNull Context context) {
    super(context);
    mContext = context;
    mWindow = getWindow();
  }

  public SofarBottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
    super(context, theme);
    mContext = context;
    mWindow = getWindow();
  }

  protected SofarBottomSheetDialog(@NonNull Context context, boolean cancelable,
