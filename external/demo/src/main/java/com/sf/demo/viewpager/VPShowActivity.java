package com.sf.demo.viewpager;

import android.content.Intent;

import com.sf.base.UIRootActivity;
import com.sf.demo.R;
import com.sf.demo.viewpager.banner.BannerActivity;
import com.sf.demo.viewpager.gallery.GalleryActivity;
...
public class VPShowActivity extends UIRootActivity {
  ...
  protected void initTitle() {
    mHeadTitleTv.setText("ViewPager效果集合");
  }
