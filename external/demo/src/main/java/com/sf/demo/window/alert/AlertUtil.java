package com.sf.demo.window.alert;
...
public class AlertUtil {
  ...
  public static void showMaterialDialog(Context context, String content, final String cancel,
      final String confirm, final AlertCallback callback) {
  ...
  // 包含一个按钮
  public static void showOneBtnDialog(Context context, String content, final String confirm,
  ...
  // 包含两个按钮
  public static void showTwoBtnDialog(Context context, String content, final String cancel,
      final String confirm, final AlertCallback callback) {
    final AlertDialog dlg = new AlertDialog.Builder(context).create();
    dlg.setCancelable(true); // 点击dlg之外的区域dlg是否消失
  ...
  // IOS风格的一个按钮
  public static void showIOSOneBtn(Context context, String title, String content,
      final String confirm, final AlertCallback callback) {
   ...
   * 用的是md风格对话框的背景
   */
  public static void showIOSTwoBtn(Context context, String title, String content,
      final String cancel, final String confirm, final AlertCallback callback) {
    // final AlertDialog dlg = new AlertDialog.Builder(context).create();
    final Dialog dlg = new Dialog(context);
    dlg.getWindow().setBackgroundDrawableResource(
        android.R.color.transparent);// 去掉背景框
