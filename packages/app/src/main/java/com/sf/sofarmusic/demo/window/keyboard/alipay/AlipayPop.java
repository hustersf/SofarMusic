package com.sf.sofarmusic.demo.window.keyboard.alipay;
...
public class AlipayPop extends PopupWindow {
    ...
    public AlipayPop(Activity context) {
        super(context);
        mContext = context;
        mView = LayoutInflater.from(mContext).inflate(R.layout.layout_pop_alipay, null);
    ...
    private void initView() {
        ...
        passView.setCorner(DensityUtil.dp2px(mContext, 5));
