...
public abstract class PullToZoomBase<T extends View> extends LinearLayout
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mRootView = onCreateRootView(context, attrs);

        HeaderViewHolder holder = onCreateHeaderView(context, attrs);
        mHeaderView = holder.mHeaderView;
        mZoomView = holder.mZoomView;
    ...
    protected abstract T onCreateRootView(Context context, AttributeSet attrs);

    protected abstract HeaderViewHolder onCreateHeaderView(Context context, AttributeSet attrs);
    ...
    public class HeaderViewHolder {
        ...
        public final View mZoomView;

        public HeaderViewHolder(View headerView, View zoomView) {
