...
public class LrcView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LrcView_lrcTextSize, DensityUtil.sp2px(getContext(), 12));
        mDividerHeight = ta.getDimension(R.styleable.LrcView_lrcDividerHeight, DensityUtil.dp2px(getContext(), 16));
