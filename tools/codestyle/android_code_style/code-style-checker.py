...
tool_path = git_root + "/tools/codestyle/android_code_style/"
style_check_command_prefix = "java -jar " + tool_path + "checkstyle/checkstyle-6.0-all.jar -c "\
    + tool_path + "android_checks.xml "
